...
address_allocation_round_robin(Config) ->
    ...
    receive
        {masque_address_assign, Sess,
         [#ip_assignment{request_id = Id1, version = 4,
                         address = A1, prefix_len = 32}]} ->
    ...
    receive
        {masque_address_assign, Sess,
         [#ip_assignment{request_id = Id2, address = A2}]} ->
